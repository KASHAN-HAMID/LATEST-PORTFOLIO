  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans relative">
      <Head>
        ...
        <meta
          name="description"
          content="Portfolio of Kashan, Full Stack Developer"
        />
      </Head>
      ...
      <div className="relative z-10">
        ...
        <section
  id="home"
  className="h-screen flex justify-center items-center text-center bg-gradient-to-br from-black via-gray-900 to-teal-900 relative overflow-hidden"
>
  ...
  <div className="relative z-10 flex items-center justify-between w-full px-6">
    ...
    <div className="flex-shrink-0 w-64 h-64 mr-16 animate-scale-in">
      <img
        src="/pfp.jpeg"
        alt="Kashan"
    ...
    <div className="text-left max-w-xl animate-fade-in animate-delay-200">
      ...
      <p className="text-xl mb-8 text-gray-300">
        Hi, I'm <span className="text-teal-400">Kashan</span>, a Full Stack Developer passionate about creating dynamic and efficient solutions.
      </p>
    </div>
  </div>
</section>
        ...
        <section id="skills" className="py-20 bg-black relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-teal-900 opacity-20 animate-gradient-move"></div>
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-8 animate-fade-in">
              {["HTML", "CSS", "JavaScript", "TypeScript", "Tailwind CSS", "Next.js", "React.js", "Node.js", "Python", "Git & GitHub", "Firebase", "Redux", "Responsive Design"].map((skill) => (
                <div
                  key={skill}
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
        { title: "Project 1", description: "An innovative web development solution.", imageUrl: "/p1.png" },
        { title: "Project 2", description: "A dynamic e-commerce platform.", imageUrl: "/p2.avif" },
        { title: "Project 3", description: "A cutting-edge portfolio website.", imageUrl: "/p3.jpg" },
        { title: "Project 4", description: "A modern blog application.", imageUrl: "/p4.jpeg" },
        { title: "Project 5", description: "A powerful social media dashboard.", imageUrl: "/p5.jpeg" },
        { title: "Project 6", description: "An AI-powered chatbot solution.", imageUrl: "/p6.png" },
      ].map((project, i) => (
        <div
          key={i}
          className="bg-gray-900 text-gray-300 p-6 rounded-lg shadow-md hover:shadow-teal-400 hover:scale-105 transition duration-300 transform"
        >
          <img
        ...
        <section id="contact" className="py-20 bg-gradient-to-r from-teal-800 to-black">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">Reach out to me through email, LinkedIn, or WhatsApp. I'd love to connect!</p>
